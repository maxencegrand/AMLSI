...
def main():
    ...
    rep=sys.argv[2]
    readers=[]
    readers.append(Reader(domain, method="Base", directory=rep))
    readers.append(Reader(domain, method="Base+PC", directory=rep))
    readers.append(Reader(domain, method="Base+PC+Tabu", directory=rep))
