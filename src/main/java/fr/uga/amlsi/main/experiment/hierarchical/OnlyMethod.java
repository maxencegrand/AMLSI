...
import fr.uga.amlsi.learning.hierarchical.HierarchicalLocalSearch;
...
//			System.out.println(neg);
			...
			for(float thresh : Properties.getPartial()) {
				...
				for(float noise : Properties.getNoise()){
					...
					Domain tmp = learningModule.generateHDDLOperator(A, ante, post);
					domain.mergeMethods(tmp);
					
					//Refinement
					LocalSearch tabu = new HierarchicalLocalSearch(allActions, pred);
