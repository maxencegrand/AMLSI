...
import fr.uga.amlsi.learning.DomainInstantiation;
/**
...
public class TemporalDomain {
	...
	public float fscore(List<TemporalExample> pos,List<TemporalExample> neg, Observation is) {
		...
		float R = fr.uga.amlsi.learning.Measure.R(iPos, pos.size());
		float P = fr.uga.amlsi.learning.Measure.P(iPos, iNeg);
	//	System.out.println(iPos+" "+iNeg);
		return fr.uga.amlsi.learning.Measure.FScore(R, P);
	}
